  ...
  header.innerHTML = `
    ...
    return `<a href="${basePath}${n.href}" class="${activePage === n.href ? 'active' : ''}">${n.label}</a>`;
        ...
        <div style="display:flex; align-items:center; gap:12px">
          <a href="https://armut.com/hizmetveren/tolga-tovac-antalya-kepez-oto-boya_70337728" target="_blank" rel="noopener" style="display:flex; align-items:center; gap:6px; padding:8px 14px; border-radius:20px; background:rgba(120,184,43,0.15); border:1px solid rgba(120,184,43,0.3); font-size:0.75rem; color:#78B82B; font-weight:600; text-decoration:none">Armut.com</a>
          <a href="https://share.google/4NpUNOn43V3WKK2TE" target="_blank" rel="noopener" title="Konum" style="display:flex; align-items:center; justify-content:center; width:36px; height:36px; border-radius:50%; background:rgba(255,255,255,0.1); border:1px solid rgba(255,255,255,0.15)">${ICONS.map}</a>
          <a href="https://www.instagram.com/nettotoboya" target="_blank" rel="noopener" title="Instagram" style="display:flex; align-items:center; justify-content:center; width:36px; height:36px; border-radius:50%; background:rgba(255,255,255,0.1); border:1px solid rgba(255,255,255,0.15)">${ICONS.instagram}</a>
        </div>
      ...
      <div class="footer-main">
        <div class="footer-col">
          ...
          <div style="margin-top:20px; display:flex; gap:10px; flex-wrap:wrap">
            <a href="https://share.google/4NpUNOn43V3WKK2TE" target="_blank" rel="noopener" title="Google Harita" style="display:flex; align-items:center; justify-content:center; width:44px; height:44px; border-radius:50%; background:rgba(66,133,244,0.15); border:1px solid rgba(66,133,244,0.3)">${ICONS.map}</a>
            <a href="${CONFIG.whatsapp}" target="_blank" rel="noopener" title="WhatsApp" style="display:flex; align-items:center; justify-content:center; width:44px; height:44px; border-radius:50%; background:rgba(37,211,102,0.15); border:1px solid rgba(37,211,102,0.3)">${ICONS.whatsapp}</a>
            <a href="https://armut.com/hizmetveren/tolga-tovac-antalya-kepez-oto-boya_70337728" target="_blank" rel="noopener" title="Armut Profil" style="display:flex; align-items:center; justify-content:center; padding:10px 16px; background:rgba(120,184,43,0.15); border:1px solid rgba(120,184,43,0.3); border-radius:22px; font-size:0.8rem; color:#78B82B; font-weight:600">Armut.com</a>
            <a href="https://www.instagram.com/nettotoboya" target="_blank" rel="noopener" title="Instagram" style="display:flex; align-items:center; justify-content:center; width:44px; height:44px; border-radius:50%; background:rgba(225,48,108,0.15); border:1px solid rgba(225,48,108,0.3)">${ICONS.instagram}</a>
          </div>
        </div>
        <div class="footer-col">
          <h3>Kurumsal</h3>
